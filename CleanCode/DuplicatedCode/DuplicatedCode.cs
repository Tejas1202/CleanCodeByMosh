...
{
    // Complying with DRY principle
    // Just extracted repeated logic in both the methods into a different method i.e. Time.Parse and of course
    // create a new type Time for that
